(function ($, window, undefined) {
	...
	var Field = acf.Field.extend({
		...
		events: {
			...
			'click .taxonomy-relationship-choices-list .acf-rel-item': 'onClickAdd',
			'click [data-name="remove_item"]': 'onClickRemove',
		},

		$control: function () {
			return this.$( '.acf-taxonomy-relationship' );
		},

		$list: function ( list ) {
			return this.$( '.taxonomy-relationship-' + list + '-list' );
		},
		...
		getAjaxData: function () {
			...
			// extra.
			ajaxData.action    = 'acf/fields/taxonomy_relationship/query';
			ajaxData.field_key = this.get( 'key' );

			// Filter.
			ajaxData = acf.applyFilters( 'taxonomy_relationship_ajax_data', ajaxData, this );
		...
		walkChoices: function (data) {// console.log(data);
